...
$("#bg_ui_title").click(function(){
	   var this_text = $(this).text();
	   if(this_text == "编辑"){
		   $(this).text("完成");
		   $("#footer_yi_main01").addClass("hide");
		   $("#footer_yi_main02").removeClass("hide");
		}else{
		   $(this).text("编辑");
		   $("#footer_yi_main01").removeClass("hide");
		   $("#footer_yi_main02").addClass("hide");
		}
   })
...
$(".jl_list_case").click(function(){
		$("#Hy_ui_001").addClass("hide"); 
		$("#Hy_ui_002").addClass("hide"); 
		$("#Hy_ui_003").removeClass("hide"); 
   })
