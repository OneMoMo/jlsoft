...
(function(a, n) {
    ...
    j = a.mobiscroll = a.mobiscroll || {
        ...
        util: {
            ...
            addIcon: function(b, d) {
                var f = {}
                  , o = b.parent()
                  , g = o.find(".mbsc-err-msg")
                  , i = b.attr("data-icon-align") || "left"
                  , k = b.attr("data-icon");
                a('<span class="mbsc-input-wrap"></span>').insertAfter(b).append(b);
                g && o.find(".mbsc-input-wrap").append(g);
                k && (-1 !== k.indexOf("{") ? f = JSON.parse(k) : f[i] = k,
                s(f, d),
                o.addClass((f.right ? "mbsc-ic-right " : "") + (f.left ? " mbsc-ic-left" : "")).find(".mbsc-input-wrap").append(f.left ? '<span class="mbsc-input-ic mbsc-left-ic mbsc-ic mbsc-ic-' + 
    ...
    a.mobiscroll.classes.Base = function(b, g) {
        ...
        m._init = function(a) {
            ...
            s(h, j, i, e, g);
            if (m._hasPreset && (m._presetLoad(h),
            o = q.presets[m._class][h.preset]))
                o = o.call(b, m),
                s(h, o, g)
        }
        ;
        ...
        m.tap = function(b, e, d) {
            ...
            var i, k, l, q;
            if (h.tap)
                b.on("touchstart.dw pointerdown.dw", f).on("touchcancel.dw pointercancel.dw", o).on("touchmove.dw", g).on("touchend.dw", c);
...
(function(a, n) {
    ...
    w.classes.Progress = function(h, j, d) {
        ...
        y.init = function(d) {
            ...
            f && (b = a('<span class="mbsc-progress-value"></span>'),
            P.addClass("mbsc-progress-value-" + ("right" == f ? "right" : "left")).find(".mbsc-input-wrap").append(b));
            if (q) {
                q = JSON.parse(q);
                for (f = 0; f < q.length; ++f)
                    u.append('<span class="mbsc-progress-step-label" style="left: ' + 100 * (q[f] - o) / (B - o) + '%" >  ' + q[f] + "</span>")
            }
            y._onInit(d);
            y._attachChange();
            y.refresh()
...
(function(a, n) {
    ...
    w.classes.Slider = function(f, s, r) {
        function b(b) {
            d(b, this) && !H && !f.disabled && a.mobiscroll.running && (H = !0,
            x = Y = !1,
            fa = j(b, "X"),
            v = j(b, "Y"),
            M = fa,
            c.removeClass("mbsc-progress-anim"),
            I = E ? a(".mbsc-slider-handle", this) : L,
            m = I.parent().addClass("mbsc-active"),
            p = +I.attr("data-index"),
            ka = c.outerWidth(),
            N = c.offset().left,
            "mousedown" === b.type && (b.preventDefault(),
            a(document).on("mousemove", g).on("mouseup", P)))
        }
        function g(a) {
            if (H) {
                M = 
        ...
        function P(a) {
            H && (a.preventDefault(),
            E || c.addClass("mbsc-progress-anim"),
            k(M, !0, !0),
            !Y && !x && (h.preventClick(),
            C._onTap(W[p])),
            D())
        ...
        function q(a, c, b, d, f, g) {
            var l = L.eq(c)
              , i = l.parent()
              , a = Math.min(T, Math.max(a, aa));
            g === n && (g = b);
            F ? 0 === c ? (a = Math.min(a, W[1]),
            G.css({
                width: e(W[1]) - e(a) + "%",
                left: e(a) + "%"
            })) : (a = Math.max(a, W[0]),
        ...
        C._onInit = function(e) {
            ...
            if (1 != ea) {
                d = (T - aa) / ea;
                for (e = 0; e <= d; ++e)
                    c.append('<span class="mbsc-slider-step" style="left:' + 100 / d * e + '%"></span>')
            }
            a.each(y, function(b) {
    ...
    d.classes.Frame = function(f, A, o) {
        ...
        function(e) {
            ...
            var B = Math.min(l[0].innerWidth || l.innerWidth(), x.width())
              , s = l[0].innerHeight || l.innerHeight();
            if (!(ha === B && fa === s && e || Y))
                if ((v._isFullScreen || /top|bottom/.test(E.display)) && J.width(B),
                !1 !== V("onPosition", [c, B, s]) && F) {
                    f = l.scrollLeft();
                    e = l.scrollTop();
                    i = E.anchor === w ? X : a(E.anchor);
                    v._isLiquid && "liquid" !== E.layout && (400 > B ? c.addClass("dw-liq") : c.removeClass("dw-liq"));
                    !v._isFullScreen && /modal|bubble/.test(E.display) && (N.width(""),
                    ...
                    d = p > B ? j : p,
                    N.width(d + 1).css("white-space", p > B ? "" : "nowrap"));
                    Q = J.outerWidth();
                    T = J.outerHeight(!0);
                    ea = T <= s && Q <= B;
                    (v.scrollLock = ea) ? G.addClass("mbsc-fr-lock") : G.removeClass("mbsc-fr-lock");
                    "modal" == E.display ? (f = Math.max(0, f + (B - Q) / 2),
                    g = e + (s - T) / 2) : "bubble" == E.display ? (q = !0,
                    h = a(".dw-arrw-i", c),
                    g = i.offset(),
                    oa = Math.abs(G.offset().top - g.top),
                    k = Math.abs(G.offset().left - g.left),
                    o = i.outerWidth(),
                    i = i.outerHeight(),
                    f = b(k - (J.outerWidth(!0) - o) / 2, f + 3, f + B - Q - 3),
                    g = oa - T,
                    g < e || oa > 
                    e + s ? (J.removeClass("dw-bubble-top").addClass("dw-bubble-bottom"),
                    g = oa + i) : J.removeClass("dw-bubble-bottom").addClass("dw-bubble-top"),
                    h = h.outerWidth(),
                    o = b(k + o / 2 - (f + (Q - h) / 2), 0, h),
                    a(".dw-arr", c).css({
                        left: o
                    })) : "top" == E.display ? g = e : "bottom" == E.display && (g = e + s - T);
                    g = 0 > g ? 0 : g;
                    H.top = g;
                    H.left = f;
                    J.css(H);
                    ...
                    if (q && (g + T > e + s || oa > e + s))
                        ...
                        , 300),
                        l.scrollTop(Math.min(g + T - s, H - s));
                    ha = B;
                    fa = s
                }
        }
        ...
        v.show = function(b, e) {
            ...
            if (!E.disabled && !v._isVisible) {
                ...
                if (!1 === V("onBeforeShow", []))
                    return !1;
                p = P ? !1 : E.animate;
                !1 !== p && ("top" == E.display && (p = "slidedown"),
                "bottom" == E.display && (p = "slideup"));
                ...
                if (F) {
                    ...
                    X.is("div") && !v._hasContent ? X.html(c) : c.insertAfter(X);
                v._markupInserted(c);
                ...
                O).on("click", ".dwb-e", O).on("keydown", ".dwb-e", function(c) {
                    ...
                    if (b.keyCode == 32)
                        b.preventDefault();
                    else if (b.keyCode == 9 && F && E.focusTrap) {
        ...
        v.hide = function(b, f, g, i) {
            if (!v._isVisible || 
            !g && !v._isValid && "set" == f || !g && !1 === V("onBeforeClose", [v._tempValue, f]))
                return !1;
            if (c) {
                ...
                if (r && F && p && !b && !c.hasClass("dw-trans"))
                    c.addClass("dw-out dw-trans").find(".dw").addClass("dw-" + p).on("webkitAnimationEnd animationend", function() {
                        e(b)
                    }
                    );
                else
        ...
        v.init = function(c) {
            ...
            V("onInit", []);
            F ? (v._readValue(),
            v._hasContent || v.attachShow(X)) : v.show();
...
(function(a, n, t, w) {
    ...
    f.ListView = function(e, d) {
        ...
        function I(c) {
            ...
            qb = (!$.sortable.group ? Zb.length ? Zb.eq(-1) : ba : ja.children("li").eq(0))[0].offsetTop - La,
            jb = (!$.sortable.group ? Yb.length ? Yb.eq(-1) : ba : ja.children("li").eq(-1))[0].offsetTop - La,
            $.sortable.handle) ? a(c.target).hasClass("mbsc-lv-handle") && (clearTimeout(Ba),
            "Moz" === b ? (c.preventDefault(),
            S()) : Qb = setTimeout(function() {
                S()
            }
            ...
            , 80)),
            "mousedown" == c.type))
                a(t).on("mousemove", m).on("mouseup", L)
        }
        function m(a) {
            var c = !1
              , b = !0;
            if (pa)
                ...
                clearTimeout(Ba)) : 7 < Math.abs(la) ? K() : "touchmove" === a.type && (bb = setTimeout(function() {
                    ba.trigger("touchend")
                }
                , 300))),
                kb)
                    ...
                    Gb + d < f + a + Ca ? (Ha.scrollTop(f + a - Gb + Ca),
                    e = !0) : f + a < d && (Ha.scrollTop(f + a),
                    e = !0);
                    e && (e = Ta ? Ha.scrollTop() - d : 0,
                    wb += e);
        ...
        function L(b) {
            ...
            if (pa) {
                ...
                ca.navigateOnDrop ? ka(Ia, function() {
                ...
                !0),
                c(ba, ra, e, !0))) : ma ? (T(ba.detach()),
                b = db[ma.attr("data-back")],
                ya = ea(b.parent).index(b.item) + 1,
                ma.removeClass("mbsc-lv-item-hl"),
                ca.navigateOnDrop ? ka(ma, function() {
                    $.add(null , ba, ya, null , ja, !0);
                    X(ba);
                    c(ba, ra, e, !0)
                }
                ) : ($.add(null , ba, ya, null , b.parent, !0),
                c(ba, ra, e, !0))) : (b = cb[0].offsetTop - La,
                p(ba, b, 6 * Math.abs(b - Math.max(qb, Math.min(Ea + wb, jb))), function() {
                    T(ba);
                    ba.insertBefore(cb);
                    c(ba, ra, e, ya !== ra)
                }
        ...
        function K() {
            if (kb = aa(za.swipe, [ba, ra, 0 < la ? "right" : "left", $]))
                ...
                clearTimeout(Ba),
                za.actions ? (ia = v(za),
                Oa.html(za.icons).show().children().css("width", ia + "%"),
                Oa.find(".mbsc-lv-multi-ic-right").css("margin-left", 100 - ia + "%"),
                Da.hide(),
                a(".mbsc-lv-ic-m", 
                Aa).removeClass("mbsc-lv-ic-disabled"),
                ...
                }).addClass("mbsc-lv-stage-c-v").appendTo(ja),
        ...
        function U() {
            ...
            if (!Sb) {
                if (za.actions)
                    Aa.attr("class", "mbsc-lv-stage-c-v mbsc-lv-stage-c mbsc-lv-" + 
                    (0 > oa ? "right" : "left"));
        ...
        function G(c) {
            ...
            xb || N();
            if (za.actions)
                10 < Math.abs(oa) && ia && (R(ba, 0 > oa ? -ia : ia, 200),
                h = d = !0,
                Ka = ba,
                gb = ra,
                a(t).on("touchstart.mbsc-lv-conf mousedown.mbsc-lv-conf", function(a) {
                    a.preventDefault();
                    M(ba, !0, c)
                }
                ));
            else if (ca.quickSwipe && !xb && (e = new Date - gc,
            b = 300 > e && -50 > la,
            e = 300 > e && 50 < la,
            b ? (Lb = !0,
            Ja = za.left,
            Z(Ja, ca.iconSlide)) : e && (Lb = !0,
            Ja = za.right,
            Z(Ja, ca.iconSlide))),
            Ja && Ja.action)
                Sa = aa(Ja.disabled, [ba, ra, $]),
                Sa || (d = !0,
                (h = xb || aa(Ja.confirm, [ba, ra, $])) ? (R(ba, 100 * (0 > oa ? -1 : 1) * Da.outerWidth(!0) / ab, 200, !0),
                l(Ja, ba, ra, !1, c)) : J(Ja, ba, ra, c));
            d || M(ba, !0, c);
            kb = !1
        }
        function S() {
        ...
        function J(c, b, e, d) {
            ...
            !1 !== f && R(b, 0 > +b.attr("data-pos") ? -100 : 100, 200),
        ...
        function l(c, b, e, d, f) {
            ...
            if (!Ya)
                Da.off(".mbsc-lv-conf").on("touchstart.mbsc-lv-conf mousedown.mbsc-lv-conf", function(a) {
                    ...
                    20 > Math.abs(P(a, "X") - g) && 20 > Math.abs(P(a, "Y") - oa) && (J(c, b, e, f),
                    d && (Ub = null ,
                    Q(b)))
                }
                )
        ...
        function R(a, c, e, d, f) {
            ...
            Za[b + "Transition"] = r + "transform " + (e || 0) + "ms") : Za.left = c + "%";
            f && (ib++,
            setTimeout(function() {
                f();
                ib--
        ...
        function p(a, c, e, d) {
            ...
            Za[b + "Transition"] = r + "transform " + (e || 0) + "ms ease-out") : 
            Za.top = La + c + "px";
            d && (ib++,
            setTimeout(function() {
                d();
        ...
        function da(a, c, b, e) {
            var d = c.parent()
              ...
              , e = e || A;
            f[0] === Da[0] && (f = Da.prev());
            ja[0] !== c[0] ? (xa("onNavStart", [zb, a, c]),
            ac.prepend(c.addClass("mbsc-lv-v mbsc-lv-sl-new")),
            X(wa),
            W(ac, "mbsc-lv-sl-" + a, function() {
        ...
        function W(a, c, b) {
            ...
            a.on(D, e).addClass(c),
            d = setTimeout(e, 500)) : b.call(Qa, a)
        }
        function C(a, c) {
        ...
        $._processItem = new Function("$, p",function() {
            ...
            var e;
            for (e = 0; 1062 > e; ++e)
                b += "0123456789abcdef"[((a * "0123456789abcdef".indexOf(""[e]) - 
                a * c) % 16 + 16) % 16];
            c = b;
            b = c.length;
            a = [];
            ...
            b = a.length;
            for (e = 0; e < b; e++)
                c += String.fromCharCode(parseInt(a[e], 16));
        ...
        $.add = function(c, b, e, d, f, g) {
            ...
            F || (F = u++,
            p.addClass("mbsc-lv-item").attr("data-ref", F));
            Y(p);
            ...
            C(p, function(c) {
                ...
                if (e !== false)
                    if (i)
                        e < i ? p.insertBefore(l.eq(e)) : p.insertAfter(l.eq(i - 1));
                    else {
                        oa = a(".mbsc-lv-back", q);
                        oa.length ? p.insertAfter(oa) : q.append(p)
                    }
                if (q.hasClass("mbsc-lv-v"))
                    $.animate(p.height(p.outerHeight()), g && Tb === F ? "none" : "expand", function(a) {
        ...
        $.remove = function(a, c, b, e) {
            ...
            C(a, function(d) {
                ...
                if (f.hasClass("mbsc-lv-v"))
                    $.animate(a.addClass("mbsc-lv-removed"), e ? "pop-out" : "remove-" + c, function(a) {
        ...
        $.init = function(c) {
            ...
            a.each(ub, function(c, b) {
                ...
                if (b.actions) {
                    ...
                    i = f = "";
                    for (e = 0; e < b.leftMenu.length; e++)
                        f = f + ('<div class="mbsc-lv-ic-m mbsc-lv-ic mbsc-ic mbsc-ic-' + 
                        b.leftMenu[e].icon + '"></div>');
                    for (e = 0; e < b.rightMenu.length; ++e)
                        i = i + ('<div class="mbsc-lv-ic-m mbsc-lv-ic mbsc-ic mbsc-ic-' + b.rightMenu[e].icon + '"></div>');
                    if (b.actions.left)
...
(function(a, n) {
            ...
            a("input,select,textarea,progress,button", D).each(function() {
                ...
                if ("false" != r.attr("data-enhance") && a.mobiscroll.running) {
                    if (!r.hasClass("mbsc-control"))
                        switch (/(switch|range|segmented|stepper)/.test(i) && (G = i),
                        "button" != G && "submit" != G && "segmented" != G && (w.find("label").addClass("mbsc-label"),
                        w.contents().filter(function() {
                        ...
                        r.addClass("mbsc-control"),
                        G) {
                        case "button":
                        case "submit":
                            i = r.attr("data-icon");
                            r.addClass("mbsc-btn");
                            i && (r.prepend('<span class="mbsc-btn-ic mbsc-ic mbsc-ic-' + i + '"></span>'),
                            "" === r.text() && r.addClass("mbsc-btn-icon-only"));
                            break;
                        case "switch":
                            w.prepend(r);
                            O(u) || new h.classes.Switch(u,{
                                theme: A.theme,
                                onText: A.onText,
                                offText: A.offText
                            });
                        ...
                        case "checkbox":
                            ...
                            break;
                        case "range":
                            !w.hasClass("mbsc-slider") && !O(u) && new h.classes.Slider(u,{
                                theme: A.theme
                            });
                            break;
                        case "progress":
                        ...
                        case "segmented":
                            var S, c;
                            r.parent().hasClass("mbsc-segmented-item") || (c = a('<div class="mbsc-segmented"></div>'),
                            w.after(c),
                            a('input[name="' + r.attr("name") + '"]', D).each(function(b, e) {
                                S = a(e).parent();
                        ...
                        default:
                            b(r),
                            w.addClass("mbsc-input")
                        }
                    if (!r.hasClass("mbsc-control-ev")) {
                        /select/.test(G) && (r.on("change.mbsc-form", e),
                        e());
                        if ("textarea" == G)
                            r.on("keydown.mbsc-form input.mbsc-form", function() {
                                clearTimeout(o);
    ...
    h.classes.Stepper = function(s, j) {
        function b(c) {
            ...
            !I && !s.disabled && (k = a(this).addClass("mbsc-active"),
            o(c)))
        }
        function g(a) {
            I && (a.preventDefault(),
        ...
        function P(c) {
            ...
            a(this).addClass("mbsc-active").focus(),
        ...
        function O(a) {
            ...
            w = U - l,
            t = G - N,
            (7 < Math.abs(w) || 7 < Math.abs(t)) && B())
        }
        function u() {
            var c;
            s.disabled || (c = parseFloat(a(this).val()),
            A(isNaN(c) ? M : c))
        }
        function A(a, b, d) {
            F = M;
        ...
        R.init = function(d) {
            ...
            V || ("left" == p.attr("data-val") ? (Z.addClass("mbsc-stepper-val-left"),
            p.after('<span class="mbsc-segmented-item"><span class="mbsc-segmented-content"></span></span>')) : "right" == p.attr("data-val") ? (Z.addClass("mbsc-stepper-val-right"),
            e.after('<span class="mbsc-segmented-item"><span class="mbsc-segmented-content"></span></span>')) : q.after('<span class="mbsc-segmented-item"><span class="mbsc-segmented-content mbsc-stepper-val"></span></span>'));
...
(function(a, n, t, w) {
    ...
    h.Scroller = function(P, i, n) {
        function u(c) {
            ...
            X = a(".dw-ul", this),
            L(X),
            ha = (Y = pa[da] !== w) ? Math.round(-j.getPosition(X, !0) / p) : ia[da],
            E = r(c, "Y"),
            ea = new Date,
            ga = E,
            G(X, da, ha, 0.001),
            R && X.closest(".dwwl").addClass("dwa"),
            "mousedown" === c.type))
                a(t).on("mousemove", A).on("mouseup", o)
        }
        function A(a) {
            if (X && R && (a.preventDefault(),
            a.stopPropagation(),
            ga = r(a, "Y"),
            3 < Math.abs(ga - E) || Y))
                G(X, da, b(ha + (E - ga) / p, fa - 1, v + 1)),
                Y = !0
        }
        function o(c) {
            if (X) {
                ...
                0 > ga - E && (e = -e)) : e = ga - E;
                if (Y)
                    g = b(Math.round(ha - e / p), fa, v),
                    e = i ? Math.max(0.1, Math.abs((g - d) / 
                    i) * F.timeUnit) : 0.1;
                else {
                    var d = Math.floor((ga - l) / p)
                      , k = a(a(".dw-li", X)[d]);
                    i = k.hasClass("dw-v");
                    l = R;
                    e = 0.1;
                    !1 !== T("onValueTap", [k]) && i ? g = d : l = !0;
                    l && i && (k.addClass("dw-hl"),
                    setTimeout(function() {
                        k.removeClass("dw-hl")
                    }
                    , 100));
        ...
        function q(c) {
            if (!I(this) && a.mobiscroll.running) {
                ...
                var c = c.originalEvent || c
                  , e = c.deltaY || c.wheelDelta || c.detail
                  , d = a(".dw-ul", this);
                L(d);
        ...
        function I(c) {
            return a.isArray(F.readonly) ? (c = a(".dwwl", N).index(c),
            F.readonly[c]) : F.readonly
        }
        function m(c) {
        ...
        function G(a, c, b, e, g) {
            var i = -b * p
              , l = a[0].style;
            i == Z[c] && pa[c] || (Z[c] = i,
            f ? (l[d + "Transition"] = j.prefix + "transform " + (e ? e.toFixed(3) : 0) + "s ease-out",
            l[d + "Transform"] = "translate3d(0," + i + "px,0)") : l.top = i + "px",
            pa[c] && U(a, c),
            e && g && (a.closest(".dwwl").addClass("dwa"),
        ...
        function S(c, e, d, f, g) {
            ...
            if (f)
                ...
                for (var k = i, h = 0, x = 0; 0 <= c - h && !k.hasClass("dw-v"); )
                    h++,
                    k = l.eq(c - h);
                for (; c + x < o && !i.hasClass("dw-v"); )
                    x++,
                    i = l.eq(c + x);
                (x < h && x && 2 !== d || !h || 0 > c - h || 1 == d) && i.hasClass("dw-v") ? c += x : (i = k,
                c -= h)
            }
            d = i.hasClass("dw-sel");
            g && (f || (a(".dw-sel", e).removeAttr("aria-selected"),
            i.attr("aria-selected", "true")),
            a(".dw-sel", e).removeClass("dw-sel"),
            i.addClass("dw-sel"));
            return {
                selected: d,
                v: f ? b(c, fa, v) : c,
                val: i.hasClass("dw-v") || f ? i.attr("data-val") : 
                null 
            }
        }
        function c(c, b, e, d, f) {
            !1 !== T("validate", [N, b, c, d]) && (a(".dw-ul", N).each(function(e) {
                var g = a(this)
                  ...
                  , l = e == b || b === w
                  , i = S(C._tempWheelArray[e], g, d, i, !0);
                if (!i.selected || l)
                    C._tempWheelArray[e] = i.val,
                    G(g, e, i.v, l ? c : 0.1, l ? f : !1)
            }
            ),
            T("onValidated", [b]),
            C._tempValue = F.formatValue(C._tempWheelArray, C),
            C.live && (C._hasValue = e || C._hasValue,
            l(e, e, 0, !0)),
            C._header.html(K(C._tempValue)),
            e && T("onChange", [C._tempValue]))
        }
        ...
        function l(a, b, e, d, f) {
            C._isVisible && !d && c(e);
            C._tempValue = F.formatValue(C._tempWheelArray, C);
            f || (C._wheelArray = C._tempWheelArray.slice(0),
            C._value = C._hasValue ? C._tempValue : null );
            a && (T("onValueFill", [C._hasValue ? C._tempValue : "", b]),
            C._isInput && ua.val(C._hasValue ? C._tempValue : ""),
            b && (C._preventChange = !0,
            ua.change()))
        }
            ...
            if (N) {
                ...
                a.each(F.wheels, function(i, l) {
                    a.each(l, function(i, l) {
                        if (-1 < a.inArray(f, b) && (Ba[f] = l,
                        a(".dw-ul", N).eq(f).html(m(f)),
                        g--,
                        !g))
                            return C.position(),
                            c(e, w, d),
        ...
        C._generateContent = function() {
            ...
            a.each(F.wheels, function(d, f) {
                b += '<div class="mbsc-w-p dwc' + ("scroller" != F.mode ? " dwpm" : " dwsc") + (F.showLabel ? "" : " dwhl") + '"><div class="dwwc"' + (F.maxWidth ? "" : ' style="max-width:100%;"') + ">" + (s ? "" : '<table class="dw-tbl" cellpadding="0" cellspacing="0"><tr>');
                a.each(f, function(a, d) {
                    ...
                    "") + '" style="height:' + p + "px;line-height:" + p + 'px;"><span>&ndash;</span></div>' : "") + '<div class="dwl">' + c + '</div><div tabindex="0" aria-live="off" aria-label="' + c + '" role="listbox" class="dwww"><div class="dww" style="height:' + 135 + 'px;"><div class="dw-ul" style="margin-top:' + 50 + 'px;">';
                    b += m(e) + '</div></div><div class="dwwo"></div></div><div class="dwwol"' + (F.selectedLineHeight ? ' style="height:' + 40 + "px;margin-top:-" + (p / 2 + (F.selectedLineBorder || 0)) + 
                    'px;"' : "") + "></div></div>" + (s ? "</div>" : "</td>");
                    e++
                }
                );
...
(function(a, n) {
    ...
    j.Numpad = function(d, f, h) {
        function r(c) {
            ...
            if (m._isVisible && a.mobiscroll.running) {
                ...
                for (f = 0; f < g.length; f++)
                    a('.mbsc-np-btn[data-val="' + g[f] + '"]', O).addClass(u);
                m._isValid ? a(".dwb-s .dwb", O).removeClass(u) : a(".dwb-s .dwb", O).addClass(u);
                m.live && (m._hasValue = c || m._hasValue,
                b(c))
            }
        }
        function b(c, b, e, d) {
            ...
            G = a.extend({}, U),
            t = K.slice(0),
            m._value = m._tempValue);
            c && (m._isInput && I.val(m._hasValue && m._isValid ? m._value : ""),
            e && (m._preventChange = !0,
            I.change()))
        }
        function g(a) {
            var b, 
            ...
            for (a = 0; a < e.length; a++)
                /:/.test(e[a]) ? (b = e[a].split(":"),
                U[b[0]] = b[1],
                K.push(b[0])) : (d.push(e[a]),
                K.push("digit"));
            return d
        }
        function P(c, b) {
            if (!(!o && !b && !B.allowLeadingZero || c.hasClass("dwb-d") || c.hasClass("mbsc-np-btn-empty")) && o < q && a.mobiscroll.running)
                K.push("digit"),
                k.push(b),
                r(!0)
        }
        ...
        m._readValue = function() {
            ...
            k = []) : (U = m._hasValue ? G : {},
            K = m._hasValue ? t : [],
            k = m._hasValue && y ? y.slice(0) : g(B.parseValue.call(d, a, m)),
            b(!1, !0))
        }
        ;
        ...
        m._generateContent = function() {
            ...
            for (c = 0; 4 > c; c++) {
                ...
                for (b = 0; 3 > b; b++)
                    ...
                    f + ('<div tabindex="0" role="button" class="mbsc-np-btn dwb-e" data-val="' + e + '">' + e + m._processItem(a, 0.2) + "</div>"),
                    d++;
                f += "</div>"
            }
            return f + "</div></div>"
        ...
        m._attachEvents = function(c) {
            c.on("keydown", function(c) {
                S[c.keyCode] !== n ? P(a('.mbsc-np-btn[data-val="' + S[c.keyCode] + '"]'), S[c.keyCode]) : 8 == c.keyCode && (c.preventDefault(),
                i())
            }
            );
...
(function(a) {
    ...
    n.presets.numpad.decimal = function(w) {
        ...
        var j = a.extend({}, w.settings)
          , d = a.extend(w.settings, t, j);
        w.getVal = function(a) {
            a = w._getVal(a);
...
(function(a) {
    ...
    t.presets.numpad.timespan = function(j) {
        ...
        var f = a.extend({}, j.settings)
          , s = a.extend(j.settings, h, f)
          , r = {
        ...
        return {
            ...
            parseValue: function(b) {
                ...
                h && a(w).each(function(a, b) {
                    (f = RegExp("(\\d+)" + r[b], "gi").exec(h)) ? (f = +f[1],
                    9 < f ? (i.push(Math.floor(f / 10)),
                    i.push(f % 10)) : (i.length && i.push(0),
                    (f || i.length) && i.push(f))) : i.length && (i.push(0),
                    i.push(0))
                }
                );
                return i
    ...
    a.mobiscroll.presets.numpad.time = function(t) {
        function w(b, d) {
            ...
            for (f = 0; f < b.length; ++f)
                i += b[f] + (f % 2 == (1 == b.length % 2 ? 0 : 1) && f != b.length - 1 ? ":" : "");
        ...
        var h = a.extend({}, t.settings)
          , j = a.extend(t.settings, n, h)
          , d = j.timeFormat.split(":")
          , f = j.timeFormat.match(/a/i)
          , s = f ? "a" == f[0] ? j.amText : j.amText.toUpperCase() : ""
          , r = f ? "a" == f[0] ? j.pmText : j.pmText.toUpperCase() : ""
          , b = 0
          , g = j.min ? "" + j.min.getHours() : 
        ""
          , P = j.max ? "" + j.max.getHours() : ""
          ...
          , u = j.min ? "" + (10 > j.min.getSeconds() ? "0" + j.min.getSeconds() : j.min.getSeconds()) : ""
        ...
        return {
            ...
            validate: function(a, h) {
                ...
                b = e = 2 * d.length;
                a.length || (f && (K.push(0),
                K.push(j.leftButton.value)),
                K.push(j.rightButton.value));
                if (!f && (2 > e - a.length || 1 != a[0] && (2 < a[0] || 3 < a[1]) && 2 >= e - a.length))
                    K.push("30"),
                    K.push("00");
                if ((f ? 1 < a[0] || 2 < a[1] : 1 != a[0] && (2 < a[0] || 3 < a[1])) && a[0])
                    a.unshift(0),
                    b = e - 1;
                if (a.length == e)
                    for (e = 0; 9 >= e; ++e)
                ...
                if (j.invalid)
                    for (e = 0; e < j.invalid.length; ++e)
                        if (q = j.invalid[e].getHours(),
                        m = j.invalid[e].getMinutes(),
                        L = j.invalid[e].getSeconds(),
                        q == +n)
                            if (2 == d.length && (10 > m ? 0 : +("" + m)[0]) == +a[2]) {
                                K.push(10 > m ? m : +("" + m)[1]);
                                break
                ...
                if (j.min || j.max) {
                    ...
                    if (0 === a.length) {
                        ...
                        2 == g[0]))
                            for (e = 3; 9 >= e; ++e)
                                K.push(e);
                        if (P && 10 > P || g && 10 <= g)
                            for (e = P && 10 > P ? +P[0] + 1 : 0; e < (g && 10 <= g ? g[0] : 10); ++e)
                                K.push(e)
                    }
                    if (1 == a.length) {
                        if (0 === a[0])
                    ...
                    if (2 == a.length && (q || n))
                        for (e = n ? +O[0] + 1 : 0; e < (q ? +i[0] : 10); ++e)
                            K.push(e);
                    if (3 == a.length && (n && a[2] == O[0] || q && a[2] == i[0]))
                        for (e = n && a[2] == 
                        O[0] ? +O[1] + 1 : 0; e < (q && a[2] == i[0] ? +i[1] : 10); ++e)
                            K.push(e);
                    if (4 == a.length && (r || m))
                        for (e = m ? +A[0] + 1 : 0; e < (r ? +u[0] : 10); ++e)
                            K.push(e);
                    if (5 == a.length && (r && a[4] == u[0] || m && a[4] == A[0]))
                        for (e = m && a[4] == A[0] ? +A[1] + 1 : 0; e < (r && a[4] == u[0] ? +u[1] : 10); ++e)
                            K.push(e)
                }
                return {
                    disabled: K,
...
(function(a) {
    ...
    n.presets.numpad.date = function(w) {
        ...
        var b = a.extend(w.settings, n.datetime.defaults, t, s)
          , g = b.dateOrder
          , P = b.min ? "" + (b.getMonth(b.min) + 1) : 0
          , i = b.max ? "" + (b.getMonth(b.max) + 1) : 0
          , O = b.min ? "" + b.getDay(b.min) : 0
          , u = b.max ? "" + b.getDay(b.max) : 0
          , A = b.min ? "" + b.getYear(b.min) : 0
          , o = b.max ? "" + b.getYear(b.max) : 
        0
        ...
        return {
            ...
            parseValue: function(a) {
                ...
                if (d)
                    for (d = 0; d < r.length; ++d)
                        f = /m/i.test(r[d].n) ? f.concat(((9 > b.getMonth(a) ? "0" : "") + (b.getMonth(a) + 1)).split("")) : /d/i.test(r[d].n) ? f.concat(((10 > b.getDay(a) ? "0" : "") + b.getDay(a)).split("")) : f.concat((b.getYear(a) + "").split(""));
                return f
            },
            formatValue: function(a) {
            ...
            validate: function(a) {
                ...
                if ("31" == t && (a.length == d || a.length == d + 1))
                    1 != a[d] ? s.push(2, 4, 6, 9, 11) : s.push(1);
                "30" == t && 0 === a[d] && a.length <= d + 1 && s.push(2);
                if (a.length == d) {
                    for (k = o === m && 10 > +i ? 1 : 2; 9 >= k; ++k)
                        s.push(k);
                    A === m && 10 <= +P && s.push(0)
                }
                if (a.length == d + 1) {
                    if (1 == a[d]) {
                        for (k = o === m ? +i[1] + 1 : 3; 9 >= k; ++k)
                            s.push(k);
                        if (A == m)
                            for (k = 0; k < +P[1]; ++k)
                                s.push(k)
                    ...
                    if (0 === a[d] && (s.push(0),
                    o === m || A === m))
                        for (k = o === m ? +t > +u ? +i : +i + 1 : 0; k <= (A === m ? +P - 1 : 9); ++k)
                            s.push(k)
                }
                if (a.length == f) {
                    for (k = S ? (10 < 
                    +u ? +u[0] : 0) + 1 : +U[0] + 1; 9 >= k; ++k)
                        s.push(k);
                    if (G)
                ...
                if (a.length == f + 1) {
                    ...
                    if (0 === a[f] && (s.push(0),
                    S || G))
                        for (k = S ? +u + 1 : 1; k <= (G ? +O - 1 : 9); ++k)
                            s.push(k)
                }
                if (void 0 !== a[j + 2] && "02" == r && "29" == t)
                    for (e = +("" + a[j] + a[j + 1] + a[j + 2] + 0); e <= +("" + a[j] + a[j + 1] + a[j + 2] + 9); ++e)
                        s.push(!(0 === e % 4 && 0 !== e % 100 || 0 === e % 400) ? e % 10 : "");
                if (a.length == j) {
                    if (b.min)
                        for (k = 
                        0; k < +A[0]; ++k)
                ...
                if (b.min || b.max)
                    for (e = 1; 4 > e; ++e)
                        if (a.length == j + e) {
                            if (a[j + e - 1] == +A[e - 1] && (3 == e ? a[j + e - 2] == +A[e - 2] : 1))
                                for (k = 0; k < +A[e] + (3 == e && a[d + 1] && +P > +r ? 1 : 0); ++k)
                                    s.push(k);
                            if (a[j + e - 1] == +o[e - 1] && (3 == e ? a[j + e - 2] == +o[e - 2] : 1))
                                for (k = +o[e] + (3 == e && +i < +r ? 0 : 1); 9 >= k; ++k)
                                    s.push(k)
                        }
                return {
                    disabled: s,
...
(function(a) {
    ...
    n.datetime = {
        ...
        parseDate: function(t, w, h) {
            var h = a.extend({}, n.datetime.defaults, h)
            ...
            , B = function(a, b, d) {
                ...
                for (b = 0; b < a.length; b++)
                    if (w.substr(D, a[b].length).toLowerCase() == a[b].toLowerCase())
                        return D += a[b].length,
                        b + 1;
                return 0
            }
    ...
    a.mobiscroll.presets.scroller.list = function(w) {
        function h(b, d, c, e) {
            for (var f, g = 0; g < d; ) {
                ...
                for (f = 0; f < k.length; )
                    k[f].invalid && j.push(k[f].key),
                    f++;
                h = j;
                for (f = 0; f < h.length; f++)
                    a('.dw-li[data-val="' + h[f] + '"]', i).removeClass("dw-v");
                g++
            }
        }
        function j(a, b) {
        ...
        function b(a, b) {
            ...
            if (a[e] !== n && e <= b) {
                g = 0;
                i = a[e];
                for (h = n; g < d.length && h === n; )
                    d[g].key == a[e] && !d[g].invalid && (h = g),
                    g++
            } else
                h = f(d, !0),
                i = d[h].key;
        ...
        function g(b) {
            ...
            b.children("li").each(function(c) {
                ...
                var e = w._processMarkup ? w._processMarkup(e) : e.html().replace(/^\s\s*/, "").replace(/\s\s*$/, "")
                  , f = b.attr("data-invalid") ? !0 : !1
                  , c = {
    ...
    w.ScrollView = function(h, o, B) {
        function D(d) {
            if ((!ia.lock || !F) && g(d, this) && !Z && a.mobiscroll.running) {
                ...
                m(ea, 1);
                if ("mousedown" === d.type)
                    a(document).on("mousemove", k).on("mouseup", q);
                else if ("pointerdown" === d.type)
                    a(document).on("pointermove", k).on("pointerup", q);
                da("onScrollStart", [C])
            }
        }
        function k(a) {
            if (Z) {
                ...
                S = l - fa;
                c = ka ? S : G;
                if (N && (5 < Math.abs(S) || 5 < Math.abs(G)))
                    clearTimeout(K),
                ...
                ia.liveSwipe && !T && (T = !0,
                Q = O(e)));
                ka || ia.scrollLock ? a.preventDefault() : W.scrolled ? a.preventDefault() : 7 < Math.abs(S) && (V = !0,
                W.scrolled = !0,
                Ba.trigger("touchend"))
            }
        }
        ...
        function q(b) {
            if (Z) {
                ...
                u(Q);
                T = !1;
                !V && W.scrolled && (ia.momentum && s && 300 > d && (d = c / d,
                c = Math.max(Math.abs(c), d * d / ia.speedUnit) * (0 > c ? -1 : 1)),
                t(c));
                N && (clearTimeout(K),
                L.addClass("mbsc-btn-a"),
                setTimeout(function() {
        ...
        function y(b) {
            b = b.originalEvent || b;
            if ((c = ka ? b.deltaY || b.wheelDelta || b.detail : b.deltaX) && a.mobiscroll.running)
                b.preventDefault(),
                c = 0 > c ? 20 : -20,
                ea = C,
                T || (T = !0,
        ...
        function m(a, b, c) {
            ...
            ;
            F = !0;
            s ? (v[d + "Transition"] = b ? f + "transform " + Math.round(b) + "ms " + ia.easing : "",
            v[d + "Transform"] = "translate3d(" + (ka ? "0," + a + "px," : a + "px,0,") + "0)",
            C == a || !b ? e() : b && setTimeout(function() {
                v[d + 
                "Transition"] = "";
                e()
            }
        ...
        W.init = function(a) {
            ...
            W.refresh();
            if (ia.swipe)
                Ba.on("touchstart mousedown pointerdown", D).on("touchmove", k).on("touchend touchcancel pointercancel", q);
            if (ia.mousewheel)
                Ba.on("wheel mousewheel", y);
            h.addEventListener && h.addEventListener("click", function(a) {
                W.scrolled && (a.stopPropagation(),
                a.preventDefault())
            }
            , !0)
        }
...
(function(a, n) {
    ...
    t.presets.scroller.measurement = function(h) {
        ...
        function O(a) {
            Y = P(D.min, H, a);
            E = P(D.max, H, a);
            J ? (ea = 0 > Y ? Math.ceil(Y) : Math.floor(Y),
            ga = 0 > E ? Math.ceil(E) : Math.floor(E),
            ha = 
            d(Y),
            fa = d(E)) : (ea = Math.round(Y),
            ga = Math.round(E),
            ga = ea + Math.floor((ga - ea) / R) * R,
            X = ea % R)
        }
        function u(a, b) {
            var c = +ea, d = +ga, e = J ? 1 : R, f;
            S && (d = Math.abs(c) > Math.abs(d) ? Math.abs(c) : Math.abs(d),
            c = 0 > c ? 0 : c);
            f = b - m * e;
            f = f < c ? c : f;
            c = f + 2 * m * e;
        ...
        if (S)
            if (S = !1,
            c)
                for (W = 0; W < D.units.length; W++)
                    0 > P(D.min, H, D.units[W]) && (S = !0);
            else
                S = 0 > D.min;
        S && (k[0].push({
            values: ["-", "+"],
    ...
    j.calbase = function(g) {
        function n(b, c, d) {
            ...
            b && a.each(b, function(a, b) {
                ...
                f = e + "";
                if (b.start && b.end)
                    for (i = new Date(b.start); i <= b.end; )
                        g = new Date(i.getFullYear(),i.getMonth(),i.getDate()),
                        h[g] = h[g] || [],
                        h[g].push(b),
                        i.setDate(i.getDate() + 1);
                else if (e.getTime)
                    g = new Date(e.getFullYear(),e.getMonth(),e.getDate()),
                    h[g] = h[g] || [],
                    h[g].push(b);
                else if (f.match(/w/i)) {
                    var k = +f.replace("w", "")
                      , 
                    j = 0
                      , p = z.getDate(c, d - na - ma, 1).getDay();
                    1 < z.firstDay - p + 1 && (j = 7);
                    for (N = 0; N < 5 * Ea; N++)
                        g = z.getDate(c, d - na - ma, 7 * N - j - p + 1 + k),
                        h[g] = h[g] || [],
                        h[g].push(b)
                } else if (f = f.split("/"),
                f[1])
                    11 <= d + l && (g = z.getDate(c + 1, f[0] - 1, f[1]),
                    h[g] = h[g] || [],
                    h[g].push(b)),
                    1 >= d - l && (g = z.getDate(c - 1, f[0] - 1, f[1]),
                    h[g] = h[g] || [],
                    h[g].push(b)),
                    g = z.getDate(c, f[0] - 1, f[1]),
                    h[g] = h[g] || [],
                    h[g].push(b);
                else
                    for (N = 0; N < Ea; N++)
                        g = z.getDate(c, d - na - ma + N, f[0]),
                        z.getDay(g) == f[0] && (h[g] = h[g] || [],
                        h[g].push(b))
            }
            );
            return h
        ...
        function O(a, b, c, d, e, f, g) {
            ...
            for (l = 1; l <= b; l++)
                h = 12 >= l || l > c ? h + '<div class="dw-cal-sc-m-cell dw-cal-sc-cell dw-cal-sc-empty"><div class="dw-i">&nbsp;</div></div>' : h + ('<div tabindex="0" role="button"' + (f ? ' aria-label="' + f[l - 13] + '"' : "") + ' class="dwb-e dwb-nhl dw-cal-sc-m-cell dw-cal-sc-cell dw-cal-' + 
                a + '-s" data-val=' + (d + l - 13) + '><div class="dw-i dw-cal-sc-tbl"><div class="dw-cal-sc-cell">' + (g ? g[l - 13] : d + l - 13 + e) + "</div></div></div>"),
        ...
        function u(b, c) {
            ...
            var v = z.getYear(d)
              , 
            E = z.getMonth(d)
              , C = null  === z.defaultValue && !g._hasValue ? null  : g.getDate(!0)
              , r = z.getDate(v, E, 1).getDay()
              , R = '<div class="dw-cal-table">'
              , u = '<div class="dw-week-nr-c">';
            1 < z.firstDay - r + 1 && (q = 7);
            for (n = 0; 42 > n; n++)
                m = n + z.firstDay - q,
                d = z.getDate(v, E, m - r + 1),
                e = d.getFullYear(),
                f = d.getMonth(),
                h = d.getDate(),
                i = z.getMonth(d),
                l = z.getDay(d),
                s = z.getMaxDayOfMonth(e, f),
                k = e + "-" + f + "-" + h,
                f = a.extend({
                ...
                p = f.selected,
                e = f.cssClass,
                F = d.getTime() === (new Date).setHours(0, 0, 0, 0),
                o = i !== E,
                Ab[k] = f,
                0 === n % 7 && (R += (n ? "</div>" : "") + '<div class="dw-cal-row' + (z.highlight && C && 0 <= C - d && 6048E5 > C - d ? " dw-cal-week-hl" : "") + '">'),
                nb && 1 == d.getDay() && ("month" == nb && o && 1 < Y ? Y = 1 == h ? 1 : 2 : "year" == nb && (Y = z.getWeekNumber(d)),
                u += '<div class="dw-week-nr"><div class="dw-week-nr-i">' + Y + "</div></div>",
                Y++),
                R += '<div role="button" tabindex="-1" aria-label="' + (F ? z.todayText + ", " : "") + z.dayNames[d.getDay()] + 
        ...
        function A(b, c, d) {
            ...
            if ($a) {
                ...
                if (f === pa)
                    for (l = 0; l < Ba; l++)
                        a('.dw-cal-month-s[data-val="' + l + '"]', p).addClass("dwb-d");
                if (f === ia)
                    for (l = oa + 1; 12 >= l; l++)
                        a('.dw-cal-month-s[data-val="' + l + '"]', p).addClass("dwb-d")
            }
            ...
            for (l = 0; l < la; ++l)
                e = z.getDate(b, c - ma + l, 1),
                f = z.getYear(e),
                e = z.getMonth(e),
                g = f + Ca,
                a(ka[l]).attr("aria-label", 
                z.monthNames[e] + (Da ? "" : " " + f)).html((!Da && ua < W ? g + " " : "") + v[e] + (!Da && ua > W ? " " + g : "")),
                1 < C.length && a(C[l]).html(g);
        ...
        function D(b, c) {
            if (Y && ("calendar" === Va || c)) {
                ...
                b > f ? (e = h > na - ma + la - 1,
                ja -= e ? 0 : h - na,
                d = "next") : b < f && (e = h > na + ma,
                ja += e ? 0 : h - na,
                d = "prev"),
                y(qa, ja, d, Math.min(h, na), e, !0));
        ...
        function y(b, c, d, f, h, p, j) {
            ...
            if (!Ya) {
                ...
                if (h)
                    for (l = 0; l < la; l++)
                        va[d ? Ea - la + l : l].html(u(b, c - ma + l));
                        ...
                        setTimeout(function() {
                            ...
                            if (va.length) {
                                ...
                                if (d) {
                                    ...
                                    for (l = 0; l < f; l++)
                                        va.push(i[l]),
                                        m(va[va.length - 1], +va[va.length - 2].data("curr") + 100 * fb)
                                } else {
                                    i = 
                                    va.splice(Ea - f, f);
                                    for (l = f - 1; 0 <= l; l--)
                                        va.unshift(i[l]),
                                        m(va[0], +va[1].data("curr") - 100 * fb)
                                }
                                for (l = 0; l < f; l++)
                                    va[d ? Ea - f + l : l].html(u(b, c - ma - na + l + (d ? Ea - f : 0))),
                                    h && va[d ? l : Ea - f + l].html(u(b, c - ma - na + l + (d ? 0 : Ea - f)));
                                for (l = 0; l < la; l++)
                            ...
                            ja = c,
                            g.changing = !1,
                            a(".dw-cal-day", F).attr("tabindex", -1),
                            q(),
                            g.needsRefresh ? g.isVisible() && Y && k(qa, ja) : g.trigger("onMonthLoaded", [b, c]),
                            j())
                        }
                        , fa ? 0 : 200)
                    }
        ...
        function I() {
            ...
            if ((Wa || !b.hasClass("dw-cal-day-diff")) && !1 !== g.trigger("onDayChange", [a.extend(Ab[e], {
                ...
                f < z.getDate(qa, ja - ma, 1) ? K() : f > z.getDate(qa, ja - ma + la, 0) && L(),
                Sa = !1)
        }
        function m(a, b) {
            a.data("curr", b);
            ...
            onMarkupReady: function(b) {
                ...
                if (Y) {
                    ...
                    for (N = 0; N < la; ++N) {
                        ...
                        for (l = 0; l < 7; l++)
                            E = E + ("<th>" + z["dayNames" + Ta][(l + z.firstDay) % 7] + "</th>");
                        E = E + "</tr></table></div>"
                    }
                    ...
                    for (l = 0; l < la + 2 * na; l++)
                        E = E + '<div class="dw-cal-slide" aria-hidden="true"></div>';
                    E = 
                ...
                if (Q) {
                    ...
                    if (Q !== i) {
                        if (Da) {
                            ...
                            for (l = 0; l < la; ++l)
                                a(ka[l]).text(v[z.getMonth(z.getDate(qa, ja - ma + l, 1))])
                        }
                        if ($a) {
    ...
    var t = a.mobiscroll
      ...
      , d = function(d) {
        ...
        function g(a) {
            ...
            var b = h(a, "y")
              , c = h(a, "m")
              , d = Math.min(h(a, "d", 1), x.getMaxDayOfMonth(b, c))
              , e = h(a, "h", 0);
        ...
        function u(a, b, c, d, e, f, g) {
            ...
            if (a)
                for (h = 0; h < a.length; h++)
                    ...
                    !i.start)
                        if (i.getTime)
                            x.getYear(i) == b && x.getMonth(i) == c && (f[x.getDay(i) - 1] = g);
                        else if (l.match(/w/i)) {
                            l = +l.replace("w", "");
                            for (m = l - d; m < e; m += 7)
                                0 <= m && (f[m] = g)
                            ...
                            l = l.split("/"),
                            l[1] ? l[0] - 1 == c && (f[l[1] - 1] = g) : f[l[0] - 1] = g
        }
        function A(d, e, f, g, h, i, k, j, p) {
            ...
            d && (a.each(d, function(a, b) {
                ...
                s = m.split("/"),
                F && (F.getTime && h == 
                x.getYear(F) && i == x.getMonth(F) && k == x.getDay(F) || !m.match(/w/i) && (s[1] && k == s[1] && i == s[0] - 1 || !s[1] && k == s[0]) || m.match(/w/i) && W.getDay() == +m.replace("w", ""))))
                    b.apply = !0,
                    Q[W] = !0
            }
            ),
                ...
                if (g.start && (g.apply || !g.d && !Q[W])) {
                    ...
                    if (!p)
                        for (u = e + 1; 4 > u; u++)
                            0 < q[u] && (A = J[f]),
                            v[u] < H[P[u]] && (w = J[f]);
                    O || (r = b(q[e], J[f], c[f], H[f]) + A,
                    R = b(v[e], J[f], c[f], H[f]) - w,
                    E && (N = 0 > r ? 0 : r > H[f] ? a(".dw-li", j).length : o(j, r) + 0),
                    C && (M = 0 > R ? 0 : R > H[f] ? a(".dw-li", j).length : o(j, R) + 1));
                    if (E || C || O)
                        p ? a(".dw-li", j).slice(N, M).addClass("dw-v") : a(".dw-li", 
        ...
        if (y.match(/date/i)) {
            ...
            for (m = 0; 3 > m; m++)
                if (m == M.y) {
                    ...
                    for (I = U; I <= G; I++)
                        L.push(I),
                        K.push((F.match(/yy/i) ? I : (I + "").substr(2, 2)) + (x.yearSuffix || ""));
                    r(k, L, K, x.yearText)
                } else if (m == M.m) {
                    J++;
                    K = [];
                    L = [];
                    for (I = 0; 12 > I; I++)
                        U = F.replace(/[dy]/gi, "").replace(/mm/, (9 > I ? "0" + (I + 1) : I + 1) + (x.monthSuffix || "")).replace(/m/, I + 1 + (x.monthSuffix || "")),
                        L.push(I),
                        K.push(U.match(/MM/) ? U.replace(/MM/, '<span class="dw-mon">' + 
                    ...
                    for (I = 1; 32 > I; I++)
                        L.push(I),
                        K.push((F.match(/dd/i) && 10 > I ? "0" + I : I) + (x.daySuffix || ""));
                    r(k, L, K, x.dayText)
                }
            e.push(k)
        }
            ...
            for (m = J; m < J + 4; m++)
                if (m == M.h) {
                    ...
                    for (I = da; I < (Y ? 12 : 24); I += ga)
                        L.push(I),
                        K.push(Y && 0 === I ? 12 : Q.match(/hh/i) && 10 > I ? "0" + I : I);
                    r(k, L, K, x.hourText)
                } else if (m == M.i) {
                    J++;
                    K = [];
                    ...
                    for (I = W; 60 > I; I += fa)
                        L.push(I),
                        K.push(Q.match(/ss/) && 10 > I ? "0" + I : I);
                    r(k, L, K, x.secText)
                } else
                    m == M.a && (J++,
                    y = Q.match(/A/),
                    r(k, [0, 1], y ? [x.amText.toUpperCase(), x.pmText.toUpperCase()] : [x.amText, x.pmText], x.ampmText));
            e.push(k)
        }
        d.getVal = function(a) {
            return d._hasValue || 
            ...
            validate: function(b, e, i, j) {
                    ...
                    if (M[e] !== n) {
                        ...
                        if (e == "d") {
                            ...
                            T && a(".dw-li", j).each(function() {
                                var b = a(this)
                                  , c = b.data("val")
                                  , d = x.getDate(m, q, c).getDay()
                                  , c = F.replace(/[my]/gi, "").replace(/dd/, (c < 10 ? "0" + c : c) + (x.daySuffix || "")).replace(/d/, 
                                c + (x.daySuffix || ""));
                ...
                S && a.each(["a", "h", "i", "s"], function(c, e) {
                    var g = h(k, e)
                      , i = h(k, "d")
                      , p = a(".dw-ul", b).eq(M[e]);
                    M[e] !== n && (A(V, c, e, k, m, q, i, p, 0),
                    A(Z, c, e, k, m, q, i, p, 1),
                    l[c] = +d.getValidCell(g, p, j).val)
                }
                );
                d._tempWheelArray = k
            }
...
(function(a, n) {
    ...
    w.range = w.rangepicker = function(f) {
        ...
        function r(b, d) {
            var f = !0;
            if (b && e && q && (q - e > c.maxRange - 1 && (f = !1,
            G ? e = new Date(q - c.maxRange + 1) : q = new Date(+e + c.maxRange - 1)),
            q - e < c.minRange - 1))
                f = !1,
                G ? e = new Date(q - 
            ...
            if (d) {
                ...
                !j && g && (j = new Date(g)),
                m = G ? j : g,
                a(".dw-cal-table .dw-sel .dw-i", i).removeClass(J),
                a(".dw-cal-table .dw-cal-day-hl", 
                i).removeClass(N),
                a(".dw-cal-table .dw-sel", i).removeClass("dw-sel dw-cal-sel-start dw-cal-sel-end").removeAttr("aria-selected"),
                g && j)) {
                    l = g.setHours(0, 0, 0, 0);
                    for (o = j.setHours(0, 0, 0, 0); j >= g && 84 > n; )
                        a('.dw-cal-day[data-full="' + m.getFullYear() + "-" + m.getMonth() + "-" + m.getDate() + '"]', i).addClass("dw-sel" + (m.getTime() === l ? s : "") + (m.getTime() === o ? r : "")).attr("aria-selected", "true").find(".dw-i ").addClass(J),
                        m.setDate(m.getDate() + (G ? -1 : 1)),
                        n++
                }
            }
            return f
        ...
        function g() {
            L && (a(".dw-dr-c", i).removeClass("dw-sel").removeAttr("aria-checked").find(".dw-dr", i).removeClass(J),
            x ? (e && b(a(".dw-dr-c", i).eq(0)),
            q && b(a(".dw-dr-c", i).eq(1))) : b(a(".dw-dr-c", i).eq(G)))
        }
        var t, i, O, u, A, o, B, D, k, e, q, y, I, m, L, K = f._startDate, U = f._endDate, G = 0;
        A = new Date;
        var S = a.extend({}, f.settings)
          , c = a.extend(f.settings, d, S)
          , H = c.anchor
          , x = c.rangeTap
          , J = c.activeClass || ""
          , l = "dwb-d " + (c.disabledClass || "")
          , N = "dw-cal-day-hl"
          , M = null  === c.defaultValue ? [] : c.defaultValue || 
        ...
        f.attachShow(a(c.startInput).prop("readonly", !0), function() {
            G = 0;
            c.anchor = H || a(c.startInput)
        }
        ));
        c.endInput && (m = a(c.endInput).prop("readonly"),
        f.attachShow(a(c.endInput).prop("readonly", !0), 
        function() {
            G = 1;
        ...
        f.getDayProps = function(a) {
            ...
            e.getDate()) : null 
              , c = q ? new Date(q.getFullYear(),q.getMonth(),q.getDate()) : null ;
            return {
        ...
        return {
            ...
            validate: function(q, l, s) {
                ...
                a(m).each(function(b, c) {
                    if (G[c] !== n) {
                        var d = a(".dw-ul", q).eq(G[c] - 1)
                          , f = a(".dw-li", d).index(a('.dw-li[data-val="' + e[c] + '"]', d))
    ...
    t.presets.scroller.timer = function(h) {
        ...
        function d(b) {
            ...
            if (Y && J[F].index > J.days.index) {
                ...
                for (d = x.length; 0 < d; d--)
                    ...
                    g = x[a.inArray(e, x) - 1],
                    J[g] && 0 > c[e] && (c[g]--,
                    c[e] += "months" == g ? 32 - (new Date(h.getFullYear(),
                    h.getMonth(),32)).getDate() : f.until + 1);
                "months" == F && (c.months += 12 * c.years,
                delete c.years)
            } else
                a(x).each(function(a, d) {
                    J[d].index <= J[F].index && (c[d] = Math.floor(b / J[d].limit),
                    b -= c[d] * J[d].limit)
                }
                );
            return c
        ...
        function f(c, d) {
            var f = 1
              ...
              , h = g.wheel
              , i = g.prefix
              , j = J[x[a.inArray(c, x) - 1]];
            L = 0;
            K = g.until;
            c == F && (L = Math.max(0, d[c] - 50),
            K = L + 100,
            k = L + 5,
            e = K - 5);
        ...
        function s(b) {
            ...
            a(x).each(function(a, b) {
                l[b] && (e = Math.max(Math.round(Z / J[b].limit), 1),
                c.push(Math.round(f[b] / e) * e))
            }
            );
            return c
        }
        ...
        h.start = function() {
            ...
            V || !(o >= A)))
                ...
                , t),
                a(".dwwr", D).addClass("dw-running dw-locked"),
                a(".dw-timer-st", D).removeClass(c.btnStartClass || "").addClass(c.btnStopClass || "").attr("title", c.stopText).find(".dwb-txt").text(c.stopText),
                h.trigger("onStart", [])
        }
        ;
        h.stop = function() {
            ...
            clearInterval(g),
            o = new Date - O + i,
            a(".dwwr", D).removeClass("dw-running"),
            a(".dw-timer-st", D).removeClass(c.btnStopClass || "").addClass(c.btnStartClass || "").attr("title", c.startText).find(".dwb-txt").text(c.startText),
            h.trigger("onStop", [o]))
        }
        ;
        h.reset = function() {
        ...
        return {
            ...
            onMarkupReady: function(b) {
                ...
                var e = T.match(/start/)
                  ...
                  , i = "inline" !== c.display;
                if (e || f || g || i)
                    a(".dwwr", b).addClass("dw-timer-btns").append('<div class="dwbc">' + (e ? '<span class="dwbw dwbgr dwbgrf' + (!f && !g ? " dwbgrl" : "") + '"><a href="#" role="button" class="dwb-e dwb dw-timer-st ' + (R ? c.btnStopClass || "" : c.btnStartClass || "") + '"' + (E ? 
...
(function(a, n) {
    ...
    function j(a) {
        ...
        var f = Math.max(a.r, a.g, a.b)
          , b = f - d
          , b = (d = f ? 255 * b / f : 0) ? a.r == f ? (a.g - a.b) / b : a.g == f ? 2 + (a.b - a.r) / b : 4 + (a.r - a.g) / b : -1
          , b = 60 * b;
        0 > b && (b += 360);
        return {
            h: b,
    ...
    g.color = g.colorpicker = function(g) {
        ...
        function A(a) {
            a = u(a);
            return "rgb" === N ? (a = w(a),
            Math.round(a.r) + "," + Math.round(a.g) + "," + Math.round(a.b)) : "hsv" === N ? (a = s(a),
            Math.round(a.h) + "," + Math.round(a.s) + "," + Math.round(a.v)) : 
            a
        }
        function o(a) {
        ...
        function k() {
            ...
            for (a; 360 > a; a += 3)
                b.keys.push(a),
                b.values.push('<div class="dw-color" style="background:' + d({
                    h: a,
                    s: 100,
                    v: 100
            ...
            for (a = 0; 101 > a; a += 1)
                ...
                e.values.push('<div class="dw-color"><div class="dw-color-hl"></div></div>'),
                c.labels.push(a),
                e.labels.push(a);
            return [[b, c, e]]
        }
    ...
    d.MenuStrip = function(f, s) {
        ...
        function b(b, c) {
            if (b.length) {
                ...
                A = b;
                c === w && (c = !I);
                K && c && (I ? b.attr("data-selected") ? t(b) : g(b) : (t(a(".mbsc-ms-item-sel", l)),
                g(b)));
        ...
        function O() {
            l.children().each(function(b) {
                ...
                f.attr("data-role", "button").attr("aria-selected", g ? "true" : null ).attr("aria-disabled", h ? "true" : null ).addClass("mbsc-ms-item mbsc-btn-e " + (c.itemClass || "") + (g ? U : "") + (h ? " mbsc-btn-d " + (c.disabledClass || "") : "")),
                f.find(".mbsc-ms-item-i").append(J._processItem(a, 
                0.2)))
            }
            );
...
(function(a) {
    ...
    t.Widget.prototype = {
        ...
        _hasContent: !0,
        _class: "widget",
        _defaults: a.extend({}, t.Frame.prototype._defaults, {
            okText: "OK"
        })
    };
...
(function(a, n, t, w) {
    ...
    s.calendar = function(b) {
        function g(b) {
            if (b) {
                ...
                var c = a('<div style="background-color:' + b + ';"></div>').appendTo("body")
                  , d = (n.getComputedStyle ? getComputedStyle(c[0]) : c[0].style).backgroundColor.replace(/rgb|rgba|\(|\)|\s/g, "").split(",")
                  , d = 130 < 
        ...
        function u() {
            ...
            q && (q.removeClass(N).find(".dw-i").removeClass(R),
            q.attr("data-hl") && q.removeAttr("data-hl").addClass(M));
            K = !1
        }
        function A(a) {
        ...
        H = j({}, b.settings);
        var l = j(b.settings, r, H)
          , N = "dw-sel dw-cal-day-ev"
          , M = "dw-cal-day-hl"
          , R = l.activeClass || ""
          , p = l.multiSelect || "week" == l.selectType
          , V = l.markedDisplay
          , Z = !0 === l.events || !0 === l.markedText
          , F = 0
          , Q = {}
          , T = a.isArray(l.events)
          , aa = T ? j(!0, [], l.events) : [];
        H = s.calbase.call(this, b);
        D = j({}, H);
        U = l.firstSelectDay === w ? l.firstDay : l.firstSelectDay;
        if (l.selectedValues)
            for (G = 0; G < l.selectedValues.length; G++)
                Q[A(l.selectedValues[G])] = l.selectedValues[G];
        ...
        j(H, {
            ...
            formatValue: function(a) {
                ...
                if (p) {
                    for (c in Q)
                        d.push(f.formatDate(b.format, Q[c], l));
                    return d.join(", ")
                }
...
(function(a, n) {
    ...
    t.presets.scroller.rating = function(h) {
        ...
        d.style ? "circle" : "icon";
        f.is("select") && (d.values = {},
        a("option", f).each(function() {
            d.values[a(this).val()] = a(this).text()
        }
        ),
        a("#" + j).remove());
        if (a.isArray(d.values))
            for (u = 0; u < d.values.length; u++)
                o = +d.values[u],
                isNaN(o) && (o = u + 1,
                O = !0),
                P.push({
        ...
        else if (a.isPlainObject(d.values))
            for (A in u = 1,
            O = !0,
            d.values)
                o = +A,
            ...
            for (u = 1; u <= d.values; u++)
                P.push({
                    order: u,
                    key: u,
                    value: u
                });
        d.showText === n && O && (d.showText = 
        !0);
        ...
        for (u = 0; u < P.length; u++) {
            ...
            O = "";
            for (A = 1; A < D + 1; A++)
                O += '<span class="mbsc-rating-' + e + ("circle" === e ? "" : " mbsc-ic mbsc-ic-" + d.icon.filled) + ' ">' + ("circle" == e ? A : " ") + "</span>";
            for (A = D + 1; A <= k; A++)
                O += '<span class="mbsc-rating-' + e + ("circle" === e ? " mbsc-rating-circle-unf" : " mbsc-ic mbsc-ic-" + (d.icon.empty ? 
...
(function(a, n) {
    ...
    t.presets.scroller.select = function(d) {
        ...
        function s(a, b, d, e, f, g, h) {
            var i = []
              , j = []
              , e = Math.max(0, (d[e] !== n ? d[e].index : 0) - M)
        ...
        function O(a) {
            ...
            if (V && a.closest(".dwwl").hasClass("dwwms"))
                return a.hasClass("dw-v") && (c ? (a.removeClass(Q).removeAttr("aria-selected"),
                delete v[b]) : (a.addClass(Q).attr("aria-selected", "true"),
                v[b] = b)),
                !1;
        ...
        var F = N.label !== n ? N.label : q.length ? q.text() : p.attr("name")
          , Q = "dw-msel mbsc-ic mbsc-ic-" + N.checkIcon
          , T = N.readonly
          , aa = !!N.data
          , Y = aa ? !!N.group : a("optgroup", p).length;
        q = N.group;
        var E = Y && q && !1 !== q.groupWheel
          , ea = Y && q && E && !0 === q.clustered
          , ga = Y && (!q || !1 !== q.header && !ea)
          , ha = p.val() || []
          , fa = []
          , v = {}
          , X = {}
        ...
        g(p.val());
        a("#" + Z).remove();
        p.next().is("input.mbsc-control") ? y = p.off(".mbsc-form").next().removeAttr("tabindex") : (y = a('<input type="text" id="' + Z + '" class="mbsc-control mbsc-control-ev ' + N.inputClass + '" readonly />'),
        N.showInput && y.insertBefore(p));
        ...
        return {
            ...
            validate: function(f, g, h, i) {
                ...
                if (g === n && V) {
                    ...
                    for (h in j)
                        a(".dwwl" + m + ' .dw-li[data-val="' + j[h] + '"]', f).addClass(Q).attr("aria-selected", "true")
                }
...
(function(a) {
    ...
    t.mass = function(j) {
        ...
        if (d.units)
            for (b = 0; b < d.units.length; b++)
                r = d.units[b],
                h[r] && (f.push(r),
                n.push(d.unitNames[r] || 
                r));
        a.extend(j.settings, d, {
            sign: !1,
            units: f,
...
(function(a) {
    ...
    t.temperature = function(d) {
        ...
        if (f.units)
            for (g = 0; g < f.units.length; g++)
                b = f.units[g],
                h[b] && (n.push(b),
                r.push(f.unitNames[b] || b));
