...
! function($) {
    ...
    var Datepicker = function(element, options) {
        ...
        this.todayFormat = options.todayFormat;
                ...
                switch (target[0].nodeName.toLowerCase()) {
                    case 'th':
                        switch (target[0].className) {
                            ...
                            case 'today':
                                var date = new Date();
                                if(this.todayFormat != undefined && this.todayFormat != ""){
                                	var todayFormat = this.todayFormat.split(":");
                                	date = UTCDate(date.getFullYear(), date.getMonth(), date.getDate(), todayFormat[0], todayFormat[1], todayFormat[2]);
                                }else{
