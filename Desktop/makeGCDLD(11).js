...
//		 makeGCDLD.getPluginObj("SH").disabled();
        ...
        if (DYDLBJ.key == 1) {
            makeGCDLD.getTab().find("li[name='BHQXS']").attr("style", "display:none");
            //湖南格力需求默认为30天
            //makeGCDLD.getTab().find("li[name='BHQXS']").val(30);
        }
    }
    debugger;
        ...
        "func": function () {
            ...
            if (BHQ < JY_BHQ) {
                ...
                JL.confirm("确认延期？", function () {
                    ...
                    var resultData = makeGCDLD.getSqlResult(queryField, "MONGO_GCDLD", "GCDLDYQ", "scm/gcgl/gcdl/search");
                    debugger;
